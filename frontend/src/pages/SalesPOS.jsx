...
export default function SalesPOS() {
  ...
  // Tax aur Service Charge ab input se aa rahe hain
  ...
  const resetAfterSale = () => {
    setCart([]);
    setDiscount(0);
    setServiceCharge(0); // reset new fields
    setTaxRate(0);
          ...
          <div className="bg-body rounded-3 shadow-sm p-3 mb-3">
            <div className="row g-2 align-items-end">
              <div className="col-12 col-md-3">
                ...
                {/* Button Group for Sale Type */}
                <div className="btn-group w-100" role="group">
                  <button
                    type="button"
                    className={`btn btn-sm ${saleType === "cash" ? "bg-primary" : "btn-outline-dark"}`}
                  ...
                  <button
                    type="button"
                    className={`btn btn-sm ${saleType === "permanent" ? "bg-primary" : "btn-outline-dark"}`}
                  ...
                  <button
                    type="button"
                    className={`btn btn-sm ${saleType === "temporary" ? "bg-primary" : "btn-outline-dark"}`}
              ...
              <div className="col-12 col-md-9">
                <label
                  className="form-label fw-bold mb-1 small"
                  style={{
                    marginLeft: "120px",
                  }}
                >
      ...
      <div id="print-receipt" style={{ display: "none" }}>
        ...
        >
          ...
          >
            ...
            {serviceCharge > 0 && (
              <p style={{ margin: "8px 0" }}>
                Service Charge: RS{serviceCharge.toFixed(0)}
              </p>
            )}
            {tax > 0 && (
              <p style={{ margin: "8px 0" }}>
                Tax ({taxRate}%): RS{tax.toFixed(0)}
              </p>
            )}
            <p style={{ margin: "8px 0" }}>
